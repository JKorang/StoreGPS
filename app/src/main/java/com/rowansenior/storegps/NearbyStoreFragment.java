...
/**
 * Created by Engineering on 5/5/15.
 */
 ...
 */
public class NearbyStoreFragment extends Fragment implements AbsListView.OnItemClickListener, View.OnClickListener {

        private OnFragmentInteractionListener mListener;
        private ArrayList<SingleStoreFragment> storeList;
        private RemoteStoreAdapter mAdapter;
        ...
        public void onCreate(Bundle savedInstanceState) {
            ...
            ArrayList<Store> nearStores = db.getNearbyStores();
            StoreMergeSort sms = new StoreMergeSort(getActivity(), false);
            try {
                sms.mergeSort(nearStores);
            } catch (IOException e) {
                e.printStackTrace();
            }
            mAdapter = new RemoteStoreAdapter(getActivity(), nearStores, 0);
        }
        ...
        public void onResume() {
            super.onResume();
            ((MainActivity) getActivity()).changeActionBarTitle("Nearby Stores");
        }
